/*!
    ...
    */
    ...
    //   $("#mainNav").show("slide", { direction: "down" }, 1000);
    // }, 
    // function(){
    //   $("#mainNav").hide("slide", { direction: "up" }, 1000);
    // });

    $("#mainNav").mouseover(function(e) {
      //$("#mainNav").hide();
      console.log('Xuxa na globo.');
    })

    $("#mainNav").mouseout(function(e) {
      //$("#mainNav"). hide("slide", { direction: "up" }, 1000);
      //$("#mainNav").style.top = "0";
      console.log('Xuxa na record.');
    })
